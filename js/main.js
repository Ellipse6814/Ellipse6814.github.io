    ...
    var ssContactForm = function () {
        ...
        $('#contactForm').validate({
            ...
            submitHandler: function (form) {
                ...
                console.log(data);
                var content = '<strong>From:    </strong> ' + data.contactName + '<br>' +
                    '<strong>Email:   </strong> ' + data.contactEmail + '<br>' +
                    '<strong>Subject: </strong> ' + data.contactSubject + '<br>' +
                    '<strong>Message:    </strong> ' + data.contactMessage;
                Email.send("Website Form <website@ellipse6814.org>",
                    "contact@ellipse6814.org",
                    "Website Form: " + data.contactSubject,
                    content,
                    {token: "7f1e8ad4-ea05-4057-bd20-23e629622e2a"});
